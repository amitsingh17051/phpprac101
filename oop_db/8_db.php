			...
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="name" value="<?php if(isset($row['name'])) {echo $row['name']; } else {
							echo "";
						}?>">
					</div>
					<div class="form-group">
						...
						while($row = $result->fetch_assoc()){
							echo '<tr>';
								...
								<form action="" method="post">
									...
									<input type="submit" class="btn btn-sm btn-warning" value="Edit" name="edit">
								</form>
								</td>';				
							echo '</tr>';
						}
